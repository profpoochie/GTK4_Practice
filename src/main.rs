...
fn build_ui(application: &gtk::Application) {
    ...
    button_3.connect_clicked(move |_| println!("Hello World"));
    ...
    button_5.connect_clicked(move |_| println!("Hello World"));
    ...
    button_6.connect_clicked(move |_| println!("Hello World"));
    ...
    button_7.connect_clicked(move |_| println!("Hello World"));
    ...
    button_8.connect_clicked(move |_| println!("Hello World"));
    ...
    button_9.connect_clicked(move |_| println!("Hello World"));
